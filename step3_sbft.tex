...
% So we can use verb in footnote
\usepackage{fancyvrb}
\VerbatimFootnotes
...
you will experience relief from your ego's reflexive desire to control everything.
...
The ego tells stories, and stories require the past or the future;
focusing on the present therefore \textit{automatically} reduces the influence of the ego.
...
Being at peace, even in difficult situations, doesn't come easy,
but it's a skill that can develop with practice. 

Recall that acceptance is a pillar of the serenity prayer:
{\small \textit{Grant me the Serenity to accept the things I cannot change}}

\actionspacing

\action{Practice Willingness} \\
\noindent
Step 3 invites us to live with intention,
not by forcing outcomes, but by aligning 
our actions with our higher power.
This begins with a pause before action,
to ask for guidance or reflect on what the next right thing might be.

How you do this is as personal as your higher power.
Some pray, some journal, others might speak intentions aloud.
What matters is the \textit{willingness} to open ourselves to something beyond ego,
and allowing that connection to shape our choices.

Surrender is not passive, it is choosing to participate in life differently.
To be guided and not driven. Consider the rest of the Serenity prayer:
{\small \textit{Grant me the courage to change the things I can, and the wisdom to know the difference.}}
...
\dotfillcols{You are justifying your actions -- to yourself or others.}{You feel no need to justify your actions.}
...
% Footnote without a key
\begingroup
\renewcommand\thefootnote{}\footnote{\verb|step3_sbft_v1.pdf| -- See \href{https://github.com/SallySoul/step3}{github.com/SallySoul/step3} for more information.}
